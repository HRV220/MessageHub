...
| last_error             | TEXT           | да   | Описание ошибки без секретов                                               |
| secret_ref             | TEXT           | нет  | Ссылка на запись в хранилище секретов Windows. Сам секрет в БД не хранится |
...
Токены, пароли и ключи сервисов **не хранятся в SQLite**. Они хранятся в защищённом хранилище Windows (Credential Manager или DPAPI), в БД — только `secret_ref`.
